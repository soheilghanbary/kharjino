import chartAnimation from '@/shared/assets/lotties/chart.json'
import moneyAnimation from '@/shared/assets/lotties/money.json'
import noteAnimation from '@/shared/assets/lotties/note.json'
import rocketAnimation from '@/shared/assets/lotties/rocket.json'
