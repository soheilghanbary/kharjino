...
export const DonateLink = () => (
  <div className="relative grid gap-2">
    ...
    <Link
      ...
      target="_blank"
      className="relative flex w-full items-center justify-center overflow-hidden rounded-full bg-primary p-2 text-primary-foreground text-sm shadow-md dark:bg-blue-600"
    >
